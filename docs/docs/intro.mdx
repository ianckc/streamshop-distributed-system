...
- **Service docs** — [catalog-api](./services/catalog-api), [order-api](./services/order-api), [event-processor](./services/event-processor), [analytics-api](./services/analytics-api)
...
- **Runbooks** — reset data, inspect Kafka lag, add a catalog replica
