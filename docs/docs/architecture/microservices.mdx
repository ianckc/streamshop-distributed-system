...
|---------|----------|-----------|------|----------|--------|
| `catalog-api` | Node.js 22 + TypeScript | Fastify | 3001 | 2 | **Built** (health + Mongo list) |
...
**Status:** **Implemented** (health + Mongo product list).

**Responsibility:** Product CRUD, image upload URLs, Redis cache-aside *(planned)*.

- Endpoints: `GET /health`, `GET /api/catalog/products`
