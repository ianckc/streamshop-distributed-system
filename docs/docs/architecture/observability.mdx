...
Observability is a key differentiator for this portfolio project. StreamShop implements the three pillars — **traces**, **metrics**, and **logs** — across all services.
...
All observability services run under the `observability` Compose profile.
