...
curl http://localhost:8080/api/catalog/products           # via Traefik (Mongo + Redis cache)
curl http://localhost:8080/api/catalog/products/prod-001  # via Traefik (Mongo + Redis cache)
